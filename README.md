...
O Agenda Fácil NAF é um sistema web desenvolvido para facilitar o agendamento de serviços no Núcleo de Apoio Contábil e Financeiro (NAF) da Unifeso.
O objetivo principal é simplificar a experiência do usuário, permitindo que estudantes, professores e a comunidade possam agendar horários de atendimento de forma rápida, organizada e acessível.
